...
import { groupTest, groupTestPartial, testCaptureGroupsByNumber } from './lib/test-lib'
...
testCaptureGroupsByNumber(regex.iso8601DayRe, iso8601DayCaptureGroupInputs, iso8601DayCaptureGroupMatches, iso8601DayCaptureGroupNumbers, 'ISO 8601 day capture groups')

// Test iso8601TimeRe
testCaptureGroupsByNumber(regex.iso8601TimeRe, iso8601TimeCaptureGroupInputs, iso8601TimeCaptureGroupMatches, iso8601TimeCaptureGroupNumbers, 'ISO 8601 time capture groups')
...
testCaptureGroupsByNumber(regex.iso8601DateRe, iso8601DateCaptureGroupInputs, iso8601DateCaptureGroupMatches, iso8601DateCaptureGroupNumbers, 'ISO 8601 date capture groups')
...
// Test rfc2822DayRe
testCaptureGroupsByNumber(regex.rfc2822DayRe, rfc2822DayCaptureGroupInputs, rfc2822DayCaptureGroupMatches, rfc2822DayCaptureGroupNumbers, 'RFC 2822 day capture groups')

// Test timezoneRe
testCaptureGroupsByNumber(regex.timezoneRe, timezoneCaptureGroupInputs, timezoneCaptureGroupMatches, timezoneCaptureGroupNumbers, 'timezone capture groups')

// Test rfc2822TimeRe
testCaptureGroupsByNumber(regex.rfc2822TimeRe, rfc2822TimeCaptureGroupInputs, rfc2822TimeCaptureGroupMatches, rfc2822TimeCaptureGroupNumbers, 'RFC 2822 time capture groups')
...
testCaptureGroupsByNumber(regex.rfc2822DateRe, rfc2822DateCaptureGroupInputs, rfc2822DateCaptureGroupMatches, rfc2822DateCaptureGroupNumbers, 'RFC 2822 date capture groups')
...
testCaptureGroupsByNumber(regex.usDateRe, usDateCaptureGroupInputs, usDateCaptureGroupMatches, usDateCaptureGroupNumbers, 'US date capture groups')
...
testCaptureGroupsByNumber(regex.intlDateRe, intlDateCaptureGroupInputs, intlDateCaptureGroupMatches, intlDateCaptureGroupNumbers, 'intl date capture groups')
...
testCaptureGroupsByNumber(regex.militaryTimeRe, militaryTimeCaptureGroupInputs, militaryTimeCaptureGroupMatches, militaryTimeCaptureGroupNumbers, 'military time capture groups')
...
testCaptureGroupsByNumber(regex.timeRe, timeCaptureGroupInputs, timeCaptureGroupMatches, timeCaptureGroupNumbers, 'time (12 hr) capture groups')
...
testCaptureGroupsByNumber(regex.twentyFourHourTimeRe, twentyFourHourTimeCaptureGroupInputs, twentyFourHourTimeCaptureGroupMatches, twentyFourHourTimeCaptureGroupNumbers, '24-hour time capture groups')
